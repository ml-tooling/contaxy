...
export default class UsersApi {
    ...
    */
     ...
     * Changes the password of a given user.  The endpoint MUST be called with basic auth credentials (user-id and password). The password can be changed by the given user or a system admin.  The password is stored as a hash.
    ...
    /**
     * Create a user.
     * Creates a user.  If the `password` is not provided, the user can only login by using other methods (social login).
