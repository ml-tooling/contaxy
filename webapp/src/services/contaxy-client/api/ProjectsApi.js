...
export default class ProjectsApi {
    ...
    */
     ...
     * Creates a new project.  We suggest to use the `suggest_project_id` endpoint to get a valid and available ID. The project ID might also be set manually, however, an error will be returned if it does not comply with the ID requirements or is already used. TODO: put method?
    ...
    createProjectWithHttpInfo(projectInput) {
      ...
      if (projectInput === undefined || projectInput === null) {
        throw new Error("Missing the required parameter 'projectInput' when calling createProject");
      }
    ...
    createProject(projectInput) {
      return this.createProjectWithHttpInfo(projectInput)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
