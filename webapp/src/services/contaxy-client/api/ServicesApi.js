...
export default class ServicesApi {
    ...
    */
    ...
    /**
     * Access a service endpoint.
     * Accesses the specified HTTP endpoint of the given service.  The endpoint should be based on the endpoint information from the service metadata. This is usually a combination of port and URL path information.  The user is expected to be redirected to the specified endpoint. If required, cookies can be attached to the response with session tokens to authorize access.
     * @param {String} projectId A valid project ID.
     * @param {String} serviceId A valid Service ID.
     * @param {String} endpoint The port and base path of the service endpoint.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object} and HTTP response
     */
    accessServiceWithHttpInfo(projectId, serviceId, endpoint) {
      let postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
        throw new Error("Missing the required parameter 'projectId' when calling accessService");
      }
      // verify the required parameter 'serviceId' is set
      if (serviceId === undefined || serviceId === null) {
        throw new Error("Missing the required parameter 'serviceId' when calling accessService");
      }
      // verify the required parameter 'endpoint' is set
      if (endpoint === undefined || endpoint === null) {
        throw new Error("Missing the required parameter 'endpoint' when calling accessService");
      }
      ...
      return this.apiClient.callApi(
        '/projects/{project_id}/services/{service_id}/access/{endpoint}', 'GET',
     ...
     */
    accessService(projectId, serviceId, endpoint) {
      return this.accessServiceWithHttpInfo(projectId, serviceId, endpoint)
    ...
    executeServiceActionWithHttpInfo(projectId, serviceId, actionId) {
      ...
      let returnType = Object;
      return this.apiClient.callApi(
        '/projects/{project_id}/services/{service_id}/actions/{action_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    executeServiceAction(projectId, serviceId, actionId) {
      return this.executeServiceActionWithHttpInfo(projectId, serviceId, actionId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
