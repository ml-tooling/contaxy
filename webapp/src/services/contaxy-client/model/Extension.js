...
class Extension {
     ...
     * @param id {String} Resource ID. Identifies a resource in a given context and time, for example, in combination with its type. Used in API operations and/or configuration files.
     */
    constructor(containerImage, id) { 
        
        Extension.initialize(this, containerImage, id);
    }
     ...
     */
    static initialize(obj, containerImage, id) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('compute')) {
                obj['compute'] = ApiClient.convertToType(data['compute'], DeploymentCompute);
            }
...
/**
 * Resource Type (Schema). Identifies what kind of resource this is. Assigned by the server and read-only.
 * @member {String} kind
 */
Extension.prototype['kind'] = undefined;
