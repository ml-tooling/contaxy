...
/**
 * Time after which the service is considered idling and will be stopped during the next idle check.If set to None, the workspace will never be considered idling.Can be specified as seconds or ISO 8601 time delta.
